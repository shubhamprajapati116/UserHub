              ...
              <div className="timeline-container">
                {loading ? (
                  Array.from({ length: 1 }).map((_, idx) => (
                    <div className="experience-card apple-card-style skeleton-exp-card" key={idx} style={{ opacity: 0.7 }}>
                      <div className="apple-card-header">
                        <div className="skeleton skeleton-avatar" style={{ width: "46px", height: "46px", borderRadius: "12px", flexShrink: 0 }}></div>

                        <div className="apple-title-group" style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                          <div className="skeleton skeleton-line" style={{ width: "55%", height: "18px" }}></div>
                          <div className="skeleton skeleton-line" style={{ width: "35%", height: "14px" }}></div>
                          <div className="skeleton skeleton-badge" style={{ width: "180px", height: "22px", borderRadius: "999px", marginTop: "4px" }}></div>
                        </div>
                      </div>
                    </div>
                  ))
                  ...
                  <>
                    {(showAllExp ? user.experience : user.experience.slice(0, 1)).map((exp) => {
                      const companyInitial = exp.company
                        ? exp.company.charAt(0).toUpperCase()
                        : "A";
                      const cleanDesc = exp.description ? exp.description.replace(/^\/\/\s*/, "").trim() : "";
                      return (
                        <div className="experience-card apple-card-style" key={exp._id}>
                          {/* Top Header Row */}
                          <div className="apple-card-header">
                            ...
                            <div className="apple-title-group">
                              ...
                              <div className="apple-blue-pill">
                                {formatDateStr(exp.startDate).toUpperCase()} — {exp.isCurrent ? "PRESENT" : formatDateStr(exp.endDate).toUpperCase()} {exp.employmentType ? `• ${exp.employmentType.toUpperCase()}` : ""}
                              </div>
                            </div>
                            ...
                            <div className="apple-card-body">
                              ...
                              <div className="apple-bullet-list">
                                {cleanDesc.split("\n").map((line, lIdx) => {
                                  ...
                                  const bulletLine = line.replace(/^[•\-\*]\s*/, "").trim();
